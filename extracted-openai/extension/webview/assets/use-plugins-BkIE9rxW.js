import{s as e}from"./chunk-Bj-mKKzh.js";import{Jn as t,Kn as n,Yn as r,cr as i,gt as a,ir as o,it as s,nr as c,or as l,rr as u,rt as d}from"./src-BZEwW6Pk.js";import{Os as f,tt as ee}from"./app-server-manager-signals-DWk_M8GO.js";import{t as p}from"./compiler-runtime-b9_ems4H.js";import{v as m}from"./persisted-signal-BOZfwzlo.js";import{s as te}from"./app-scope-DrEO_-1u.js";import{A as ne,n as h,r as re,u as ie,v as ae}from"./vscode-api-BQyiA7Nu.js";import{M as g}from"./index.extension-DWAHrUEK.js";import{o as oe}from"./statsig-xCsfi4No.js";import{t as se}from"./invalidate-queries-and-broadcast-D74fC6LN.js";import{d as ce}from"./thread-context-inputs-BKqUp3p6.js";import{n as le}from"./use-auth-BlXLRbru.js";import{t as ue}from"./use-codex-home-ilRh3uw2.js";import{i as de,n as fe,r as pe,t as me}from"./use-is-plugins-enabled-CRlE2OoY.js";function _(){return window.electronBridge?.getBuildFlavor?.()||`prod`}var v=`<svg width="192" height="192" viewBox="0 0 192 192" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`].map(e=>`data:image/svg+xml,${encodeURIComponent(e)}`);var k=e(i(),1),A={".svg":`image/svg+xml`,".png":`image/png`,".jpg":`image/jpeg`,".jpeg":`image/jpeg`,".webp":`image/webp`,".gif":`image/gif`,".avif":`image/avif`};async function j(e,t,n){let r=M(e);if(r==null)return null;try{let e={path:r,hostId:t},i=await n.fetchQuery({queryFn:({signal:t})=>h(`read-file-binary`,{params:e,signal:t}),queryKey:re(`read-file-binary`,e),retry:!1,gcTime:1/0,staleTime:ie.INFINITE});return i.contentsBase64?`data:${N(r)};base64,${i.contentsBase64}`:null}catch(e){return m.warning(`Failed to inline local image`,{safe:{},sensitive:{error:e,resolvedImagePath:r}}),null}}function M(e){if(e==null)return null;let t=e.trim();if(t.length===0)return null;let n=t.toLowerCase();if(n.startsWith(`data:`)||n.startsWith(`http:`)||n.startsWith(`https:`)||n.startsWith(`file:`)||n.startsWith(`vscode-resource:`)||n.startsWith(`vscode-webview:`)||n.startsWith(`vscode-file:`))return null;let r=l(t);return c(r)?r:null}function N(e){return A[k.default.extname(e).toLowerCase()]??`application/octet-stream`}var ge=p(),P=[`plugins`],F=`openai-curated-marketplaces-hidden`,I=4,L=[],_e=[],R=[],ve=[],ye=[],z=[],be=[d],xe=[d,s],B=`computer-use`,V=`.tmp/marketplaces/openai-internal-testing`,H=[`datadog`,`statsig`],U=new Set([`codex-official`,n,d,s,`openai-primary-runtime`].map(He));function W(e){return{...$(e.summary),description:e.summary.interface?.shortDescription??e.description??null,displayName:e.summary.interface?.displayName??null,marketplaceDisplayName:null,marketplaceName:e.marketplaceName,plugin:e.summary,keywords:e.summary.keywords,...Z({marketplaceName:e.marketplaceName,marketplacePath:e.marketplacePath})}}function G({marketplacePath:e,remoteMarketplaceName:t}){if(e!=null&&t!=null)throw Error(`plugin marketplace request requires one marketplace source`);if(e!=null)return{marketplacePath:e};if(t!=null)return{remoteMarketplaceName:t};throw Error(`plugin marketplace request requires a marketplace source`)}function K(e){return e.marketplacePath??`remote:${e.remoteMarketplaceName}`}function Se(e){return e.filter(e=>{let t=Q(e).toLowerCase();return!H.some(e=>t===e||t.startsWith(`${e}-`))})}function q(e){return e.marketplacePath==null?Y(e.plugin):e.plugin.name}function J(e){return e.marketplacePath==null?Y(e.plugin):e.plugin.id}function Y(e){if(e.remotePluginId==null)throw Error(`remote plugin ${e.id} is missing remotePluginId`);return e.remotePluginId}function X(e){return{...G(e),pluginName:q(e)}}function Z({marketplaceName:e,marketplacePath:t}){return t==null?{marketplacePath:null,remoteMarketplaceName:e}:{marketplacePath:t,remoteMarketplaceName:null}}function Ce(e,t,n){let r=(0,ge.c)(53),i;r[0]===e?i=r[1]:(i={hostId:e},r[0]=e,r[1]=i);let a=me(i)&&(n?.enabled??!0),o=n?.additionalMarketplaceKinds??R,s=n?.installSuggestionPluginNames??null,c=oe(`4218407052`),l=he(le(e)?.authMethod??null),u=ve;l?u=xe:c&&(u=be);let d=ke({additionalMarketplaceKinds:o,includeRemoteCatalog:n?.includeRemoteCatalog??!0,includeVerticalCatalog:!c}),p=se(),m=ne(),h=te(ce),re=ue(e),g=te(ee),_;r[2]!==e||r[3]!==g?(_=g.includes(e),r[2]=e,r[3]=g,r[4]=_):_=r[4];let v=_,y=a&&v,b;r[5]!==e||r[6]!==y?(b={enabled:y,hostId:e},r[5]=e,r[6]=y,r[7]=b):b=r[7];let x=de(b),S;r[8]===e?S=r[9]:(S={hostId:e},r[8]=e,r[9]=S);let C=fe(S),w;r[10]===e?w=r[11]:(w={hostId:e},r[10]=e,r[11]=w);let T=pe(w),E=t===void 0,D=Ke({codexHome:re,hostId:e,rootsOverrideCwd:t,workspaceRoots:h.data?.roots}),O=a&&v&&(t!==void 0||h.isFetched),k;r[12]===Symbol.for(`react.memo_cache_sentinel`)?(k=null,r[12]=k):k=r[12];let A=k,j=s==null?Ae(e,D,d,c,l):De(e,D,R,s,c,l),M;r[13]!==A||r[14]!==u||r[15]!==e||r[16]!==s||r[17]!==d||r[18]!==m||r[19]!==D?(M=async()=>{if(s!=null){let t=await f(`send-cli-request-for-host`,{hostId:e,method:`plugin/installed`,params:{...D.length>0?{cwds:D}:{},installSuggestionPluginNames:s}}),n=Me(t.marketplaces,u),r=Ye(n);return{featuredPluginIds:L,marketplaceLoadErrors:t.marketplaceLoadErrors,marketplaces:We(n),plugins:await Ge({hostId:e,plugins:r,queryClient:m})}}let t=await f(`list-plugins`,d==null?{hostId:e,...D.length>0?{cwds:D}:{}}:{hostId:e,...D.length>0?{cwds:D}:{},marketplaceKinds:d}),n=Me(t.marketplaces,u),r=Ye(n),i=A==null?r:Ve({buildFlavor:A,plugins:r}),a=Se(t.featuredPluginIds).filter(e=>!u.some(t=>e.endsWith(`@${t}`)));return{featuredPluginIds:A==null?a:Be({buildFlavor:A,featuredPluginIds:a}),marketplaceLoadErrors:t.marketplaceLoadErrors,marketplaces:We(n),plugins:await Ge({hostId:e,plugins:i,queryClient:m})}},r[13]=A,r[14]=u,r[15]=e,r[16]=s,r[17]=d,r[18]=m,r[19]=D,r[20]=M):M=r[20];let N;r[21]!==O||r[22]!==j||r[23]!==M?(N={queryKey:j,queryFn:M,enabled:O,staleTime:ie.FIVE_MINUTES,gcTime:1/0},r[21]=O,r[22]=j,r[23]=M,r[24]=N):N=r[24];let F=ae(N);if(!a||!v){let e;return r[25]===Symbol.for(`react.memo_cache_sentinel`)?(e={availablePlugins:z,featuredPluginIds:L,installedPlugins:z,marketplaceLoadErrors:_e,marketplaces:ye,errorMessage:null,isLoading:!1,isFetching:!1,refetch:Te,forceReload:we},r[25]=e):e=r[25],e}let I,B,V,H;r[26]!==x.available||r[27]!==T.available||r[28]!==C.available||r[29]!==F.data?.featuredPluginIds||r[30]!==F.data?.plugins?(I={isComputerUseAvailable:x.available,isExternalBrowserUseAvailable:T.available,isInAppBrowserUseAvailable:C.available},B=F.data?.plugins??z,V=Pe({plugins:B,...I}),H=Ne({featuredPluginIds:F.data?.featuredPluginIds??L,...I}),r[26]=x.available,r[27]=T.available,r[28]=C.available,r[29]=F.data?.featuredPluginIds,r[30]=F.data?.plugins,r[31]=I,r[32]=B,r[33]=V,r[34]=H):(I=r[31],B=r[32],V=r[33],H=r[34]);let U;r[35]===B?U=r[36]:(U=Fe(B),r[35]=B,r[36]=U);let W=F.data?.marketplaceLoadErrors??_e,G=F.data?.marketplaces??ye,K=F.error?String(F.error.message):null,q=E&&h.isLoading||F.isLoading||C.isLoading||T.isLoading||x.isLoading,J=E&&h.isFetching||F.isFetching||x.isFetching,Y;r[37]!==I||r[38]!==F?(Y=async()=>{let e=(await F.refetch()).data?.plugins??z;return{availablePlugins:Pe({plugins:e,...I}),installedPlugins:Fe(e)}},r[37]=I,r[38]=F,r[39]=Y):Y=r[39];let X;r[40]===p?X=r[41]:(X=()=>p(P),r[40]=p,r[41]=X);let Z;return r[42]!==V||r[43]!==H||r[44]!==U||r[45]!==W||r[46]!==G||r[47]!==K||r[48]!==q||r[49]!==J||r[50]!==Y||r[51]!==X?(Z={availablePlugins:V,featuredPluginIds:H,installedPlugins:U,marketplaceLoadErrors:W,marketplaces:G,errorMessage:K,isLoading:q,isFetching:J,refetch:Y,forceReload:X},r[42]=V,r[43]=H,r[44]=U,r[45]=W,r[46]=G,r[47]=K,r[48]=q,r[49]=J,r[50]=Y,r[51]=X,r[52]=Z):Z=r[52],Z}async function we(){}async function Te(){return{availablePlugins:z,installedPlugins:z}}function Ee(e){let t=(0,ge.c)(10),{enabled:n,hostId:r,marketplaceKind:i}=e,a=n===void 0?!0:n,o;t[0]===r?o=t[1]:(o={hostId:r},t[0]=r,t[1]=o);let s=me(o),c,l;t[2]!==r||t[3]!==i?(c=[...P,`marketplace-kind`,r,i],l=async()=>Ye((await f(`list-plugins`,{hostId:r,marketplaceKinds:[i]})).marketplaces),t[2]=r,t[3]=i,t[4]=c,t[5]=l):(c=t[4],l=t[5]);let u=a&&s,d;return t[6]!==c||t[7]!==l||t[8]!==u?(d={queryKey:c,queryFn:l,enabled:u,staleTime:ie.FIVE_MINUTES},t[6]=c,t[7]=l,t[8]=u,t[9]=d):d=t[9],ae(d)}function De(e,t,n=R,r=null,i=!1,a=!1){return r==null?Ae(e,t,ke({additionalMarketplaceKinds:n,includeRemoteCatalog:!0,includeVerticalCatalog:!i}),i,a):Oe([...P,e,t,`installed`,r,`curated-marketplace`,je(i)],a)}function Oe(e,t){return t?[...e,F]:e}function ke({additionalMarketplaceKinds:e,includeRemoteCatalog:t,includeVerticalCatalog:n}){return t&&!n&&e.length===0?null:n?[`local`,`vertical`,...e]:[`local`,...e]}function Ae(e,t,n,r,i){let a=je(r);return Oe(n==null?[...P,e,t,`curated-marketplace`,a]:[...P,e,t,`marketplace-kinds`,n,`curated-marketplace`,a],i)}function je(e){return e?s:d}function Me(e,t){return t.length===0?e:e.filter(e=>!t.includes(e.name))}function Ne({featuredPluginIds:e,...t}){return e.filter(e=>Ie(e,t))}function Pe({plugins:e,...t}){return e.filter(e=>Ie(e.plugin.id,t))}function Fe(e){return e.filter(e=>e.plugin.installed)}function Ie(e,{isComputerUseAvailable:t,isExternalBrowserUseAvailable:n,isInAppBrowserUseAvailable:r}){return!(!r&&Le(e)||!n&&Re(e)||!t&&ze(e))}function Le(e){let t=Q(e);return t===`browser`||t===`browser-use`}function Re(e){let t=Q(e);return t===`chrome`||t===`chrome-dev`||t===`chrome-internal`}function ze(e){return Q(e)===B}function Q(e){return e.split(`@`)[0]}function Be({buildFlavor:e,featuredPluginIds:n}){let i=t(e);return n.filter(e=>{let t=a(e);return t==null?!0:!r(t)||t===i})}function Ve({buildFlavor:e,plugins:n}){let i=t(e);return n.filter(e=>!r(e.marketplaceName)||e.marketplaceName===i)}function He(e){return e.trim().toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)}function Ue(e){return U.has(He(e))}function We(e){let t=new Map;for(let n of e){let e=`${n.name}\u0000${n.path??``}`;if(t.has(e))continue;let r=Ue(n.name);t.set(e,{displayName:n.interface?.displayName??null,isBuiltIn:r,name:n.name,path:n.path,pluginCount:n.plugins.length})}return Array.from(t.values()).sort((e,t)=>{let n=e.displayName?.trim()||e.name,r=t.displayName?.trim()||t.name;return n.localeCompare(r)})}async function Ge({hostId:e,plugins:t,queryClient:n}){let r=[...t];async function i(a){let o=t[a];if(o==null)return;let[s,c]=await Promise.all([j(o.composerIconPath,e,n),j(o.logoPath,e,n)]);(s!=null||c!=null)&&(r[a]={...o,composerIconPath:s??o.composerIconPath,logoPath:c??o.logoPath,plugin:o.plugin.interface?{...o.plugin,interface:{...o.plugin.interface,...s==null?{}:{composerIcon:s},...c==null?{}:{logo:c}}}:o.plugin}),await i(a+I)}return await Promise.all(Array.from({length:Math.min(I,t.length)},(e,t)=>i(t))),r}function Ke({codexHome:e,hostId:t,rootsOverrideCwd:n,workspaceRoots:r}){let i=t===`local`&&e!=null?g(e,V):null;return qe([...typeof n==`string`?[n]:n??r??[],...i==null?[]:[i]],e)}function qe(e,t){return Array.from(new Set(e.map(e=>e.trim()).filter(e=>c(e)&&Je(e,t))))}function Je(e,t){return t==null?!0:u(t)||o(t)?u(e)||o(e):e.startsWith(`/`)&&!e.startsWith(`//`)}function Ye(e){let t=new Map;for(let n of e)for(let e of n.plugins)t.has(e.id)||t.set(e.id,{...$(e),description:e.interface?.shortDescription??null,displayName:e.interface?.displayName??null,marketplaceDisplayName:n.interface?.displayName??null,marketplaceName:n.name,plugin:e,keywords:e.keywords,...Z({marketplaceName:n.name,marketplacePath:n.path})});return Array.from(t.values())}function $(e){let t=T(e);return t==null?{composerIconPath:e.interface?.composerIcon??e.interface?.composerIconUrl??null,logoPath:e.interface?.logo??e.interface?.logoUrl??null}:{composerIconPath:t,logoPath:t}}export{j as _,G as a,J as c,ze as d,Re as f,M as g,Ee as h,K as i,Y as l,Ce as m,W as n,X as o,Le as p,$ as r,q as s,P as t,Ue as u,he as v,_ as y};
//# sourceMappingURL=use-plugins-BkIE9rxW.js.map